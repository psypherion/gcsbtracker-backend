...
from scraper import Scraper  # Make sure to import your Scraper class
...
def extract_id_from_url(profile_url: str) -> str:
    ...
    return profile_url.split('/')[-1]  # Gets the last part of the URL
...
def extract_profiles_to_json(csv_file: str, json_file: str) -> None:
    ...
    for student in students:
        ...
        profile_id = extract_id_from_url(profile_url)  # Extract the profile ID
...
if __name__ == "__main__":
    csv_file_path = "GCSJ_data.csv"  # Replace with your actual CSV file path
